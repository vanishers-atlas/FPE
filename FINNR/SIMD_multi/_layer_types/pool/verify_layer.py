...
if __name__ == "__main__":
    ...
    test_layer(data_rows, data_cols, data_depth, 2, number_tests, test_time)

    #test_layer(data_rows, data_cols, data_depth, 4, number_tests, test_time)

    #test_layer(data_rows, data_cols, data_depth, 8, number_tests, test_time)
