...
def generate_testbrench_file(input_data, output_data, num_tests, kickoffs_per_test):
...
def test_layer(input_neurons, output_neurons, number_tests, test_time, batch_size):
    ...
    generate_layer.generate_layer(".\\verifying", "varifying", input_neurons, output_neurons, batch_size, use_BRAMs=False, pregened_memfiles=["ROM_A"] )

    # Generate testbench
    test_input = generate_data_input(number_tests, input_neurons)
    test_output = generate_data_output(test_input, parameters)

    generate_testbrench_file(test_input, test_output, number_tests, int(input_neurons/batch_size))
...
if __name__ == "__main__":
    ...
    print("Testing layer, batch size 4")
    test_layer(input_neurons, output_neurons, number_tests, test_time, 4)

    print("Testing layer, batch size 1")
    test_layer(input_neurons, output_neurons, number_tests, test_time, 1)
