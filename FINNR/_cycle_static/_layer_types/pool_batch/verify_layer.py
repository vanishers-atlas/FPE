...
def test_layer(data_rows, data_cols, data_depth, number_tests, test_time, batch_size):

    # Generate program files
    generate_layer.generate_layer(".\\verifying", "varifying", data_rows, data_cols, data_depth, batch_size, use_BRAMs=False, pregened_memfiles=[ ] )
...
if __name__ == "__main__":
    ...
    test_layer(data_rows, data_cols, data_depth, number_tests, test_time, data_depth)

    print("Testing layer, batch size 4")
    test_layer(data_rows, data_cols, data_depth, number_tests, test_time, 4)

    print("Testing layer, batch size 1")
    test_layer(data_rows, data_cols, data_depth, number_tests, test_time, 1)
