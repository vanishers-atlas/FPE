...
def test_layer(data_rows, data_cols, data_depth, number_tests, test_time):
    ...
    assert data_cols % 2 == 0, "data_cols must be even for pool_pairs layer type"
    generate_testbrench_file(test_input, test_output, number_tests, int(data_cols/2)*data_rows )
