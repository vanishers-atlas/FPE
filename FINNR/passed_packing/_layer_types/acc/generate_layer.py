...
def generate_layer(path, layer_name, input_neurons, output_neurons, input_packing, use_BRAMs=False, pregened_memfiles=None):
    # Generate toolchain input files
    generate_layer_fpea(path, layer_name, input_neurons, output_neurons, input_packing)
    parameters, generics = generate_layer_parameters_and_generics(path, layer_name, input_neurons, output_neurons, input_packing, use_BRAMs)
...
def generate_layer_fpea(path, layer_name, input_neurons, output_neurons, input_packing):
...
def generate_layer_parameters_and_generics(path, layer_name, input_neurons, output_neurons, input_packing, use_BRAMs):
    assert input_neurons % input_packing == 0
    ...
    popcount_width = tc_utils.unsigned.width(input_neurons)
    ALU_width = max(popcount_width, input_packing)
