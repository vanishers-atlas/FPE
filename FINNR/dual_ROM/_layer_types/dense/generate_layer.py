...
def generate_layer_parameters_and_generics(path, layer_name, input_neurons, output_neurons, use_BRAMs):
	...
	num_weights = output_neurons * input_neurons
	num_gammas  = output_neurons
	num_threasholds = output_neurons

	ROMA_depth = num_weights + num_gammas
	ROMB_depth = num_threasholds
	...
	parameters = {
		...
		"address_sources": {
			...
			"BAM_1": {
				...
				"offset_max": ROMA_depth - 1,
				"step_max": 1
			},
			#  thresholds
			"BAM_2": {
				"addr_max": ROMB_depth - 1 ,
				"offset_max": ROMB_depth - 1,
				"step_max": 1
			}
		},
		"data_memories": {
