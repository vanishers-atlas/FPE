...
def test_layer(data_rows, data_cols, data_depth, number_tests, parallelism_factor, test_time):

    # Generate program files
    generate_layer.generate_layer(".\\verifying", "varifying", data_rows, data_cols, data_depth, parallelism_factor, use_BRAMs=False, pregened_memfiles=[ ] )
...
if __name__ == "__main__":
    ...
    print("verifying parallelism factor = data_depth")
    test_layer(data_rows, data_cols, data_depth, number_tests, data_depth, test_time)
    print()

    print("verifying parallelism factor < data_depth")
    test_layer(data_rows, data_cols, data_depth, number_tests, 4, test_time)
    print()
