...
def test_layer(input_neurons, output_neurons, number_tests, parallelism_factor, test_time):
    ...
    generate_layer.generate_layer(".\\verifying", "varifying", input_neurons, output_neurons, parallelism_factor,
...
if __name__ == "__main__":
    ...
    test_layer(input_neurons, output_neurons, number_tests, 2, test_time)
    print()

    print("verifying parallelism factor = 4")
    test_layer(input_neurons, output_neurons, number_tests, 4, test_time)
    print()

    print("verifying parallelism factor = 8")
    test_layer(input_neurons, output_neurons, number_tests, 8, test_time)
    print()
