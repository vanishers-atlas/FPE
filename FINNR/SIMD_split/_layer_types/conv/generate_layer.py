...
def generate_layer(path, layer_name, data_cols, data_rows, data_depth, num_kernals, num_lanes, use_BRAMs=False, pregened_memfiles=None):
    ...
    generate_layer_fpea(path, layer_name, data_cols, data_rows, data_depth, kernals_per_lane)
    parameters, generics = generate_layer_parameters_and_generics(path, layer_name, data_cols, data_rows, data_depth, kernals_per_lane, num_lanes, use_BRAMs, pregened_memfiles)
