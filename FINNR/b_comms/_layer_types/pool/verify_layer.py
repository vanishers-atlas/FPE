...
def test_layer(data_rows, data_cols, data_depth, number_tests, test_time):

    # Generate program files
    generate_layer.generate_layer(".\\verifying", "varifying", data_rows, data_cols, data_depth, use_BRAMs=False, pregened_memfiles=[ ] )
...
if __name__ == "__main__":
    ...
    test_layer(data_rows, data_cols, data_depth, number_tests, test_time)
