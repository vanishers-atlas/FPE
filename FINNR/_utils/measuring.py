...
def impl_and_simulate_network(network_name, network_folder, dir_pathway, measure_area=True, measure_timing=False, compute_timing_metrics=False):
    ...
    with open(script, "w") as f:
        ...
        f.write("set_property library work [get_files  %s/%s/measuring/measuring.srcs/sources_1/bd/network/hdl/network_wrapper.vhd]\n"%(dir_pathway.replace("\\", "/"), network_name, ) )
