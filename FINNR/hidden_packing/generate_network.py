    ...
    for layer, layer_details in enumerate(layers):
        ...
        if   layer_details["type"] == "conv":
            if layer_details["packing_factor"] == None:
                layer_details["packing_factor"] = conv.compute_max_packing(layer_depth)
            ...
            if layer_details["packing_factor"] == None:
                layer_details["packing_factor"] = pool.compute_max_packing(layer_depth)
            ...
            if layer_details["packing_factor"] == None:
                layer_details["packing_factor"] = dense.compute_max_packing(layer_width * layer_height * layer_depth)
            ...
            if layer_details["packing_factor"] == None:
                layer_details["packing_factor"] = acc.compute_max_packing(layer_width * layer_height * layer_depth)
        ...
        print(layer, layer_details["packing_factor"])
