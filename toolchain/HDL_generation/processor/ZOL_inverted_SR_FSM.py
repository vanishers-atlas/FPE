...
def generate_FSM():
    ...
    ARCH_BODY += "\<begin\>\n"
    ARCH_BODY += "if rising_edge(clock) and match_found = '1' then\>\n"
    ARCH_BODY += "curr_state <= next_state;\n"
    ARCH_BODY += "\<end if;\n"
    ARCH_BODY += "\<end process;\n\n"

    ARCH_BODY += "-- next_state computing\n"
    ARCH_BODY += "next_state <=\> '0' when curr_state = '1' and match_found = '1'\n"
    ARCH_BODY += "else '1' when curr_state = '0' and overwrites_reached = '1'\n"
    ARCH_BODY += "else curr_state;\<\n\n"

    ARCH_BODY += "not_tracking <= curr_state;\n"
