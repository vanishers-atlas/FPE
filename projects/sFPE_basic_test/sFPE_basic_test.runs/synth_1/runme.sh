...
HD_PWD='D:/sfpe/projects/sFPE_basic_test/sFPE_basic_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sFPE.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sFPE.tcl
