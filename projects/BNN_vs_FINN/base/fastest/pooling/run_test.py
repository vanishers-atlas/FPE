...
def run_test(path="."):
    ...
    utils.run_toolchain(
        path + "\\pooling_layer_test_program.fpea",
        path + "\\pooling_layer_test_parameters.json",
        path + "\\pooling_layer_test_generics.json",
    ...
    vhdl_files.append(path + "\\testbench_test.vhd")
