...
entity axis_slave_master_ip_v1_0_S00_AXIS is
	generic (
...
end axis_slave_master_ip_v1_0_S00_AXIS;

architecture arch_imp of axis_slave_master_ip_v1_0_S00_AXIS is
...
--	end generate FIFO_GEN;
	...
	-- Add user logic here
	start <= '1' when writes_done = '1' else '0';
--    SSP_WREN <= '1' when (fifo_wren = '1') else '0';
    SSP_WREN <= fifo_wren;
    SSP_DATA_OUT <= S_AXIS_TDATA  when (fifo_wren = '1') else (others => '0');
--    SSP_DATA_OUT <= S_AXIS_TDATA;
	-- User logic ends
