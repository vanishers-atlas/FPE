...
def generate_tcl_script(network_name, network_folder, input_dims, network_structure):
    ...
    for layer in range(len(network_structure)):
        ...
        if layer != LAST_LAYER:
            ...
            tcl_script += "connect_bd_net [get_bd_pins layer_%i_running_edge_detector/falling_edge_detected] [get_bd_pins layer_%i_space_ready/S]\n"%(layer + 1, layer )
...
if __name__ == "__main__":
    ...
    network_name = "base_dev_area_flag"
