...
if __name__ == "__main__":
    ...
    meas_utils.impl_and_simulate_network(network_name, network_folder, dir_pathway, measure_area=False, measure_timing=True, compute_timing_metrics=True)
