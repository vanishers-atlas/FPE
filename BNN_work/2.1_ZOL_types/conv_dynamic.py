...
# Input Layer types
from _layer_templates.conv_dynamic   import realise_template as conv
from _layer_templates.pool_ripple    import realise_template as pool
from _layer_templates.dense_ripple   import realise_template as dense
