...
# Input Layer types
from _layer_templates.conv_ripple    import realise_template as conv
from _layer_templates.pool_ripple    import realise_template as pool
from _layer_templates.dense_cascade  import realise_template as dense
from _layer_templates.acc_ripple     import realise_template as acc
...
if __name__ == "__main__":
    ...
    meas_utils.impl_and_simulate_network(network_name, network_folder, dir_pathway, measure_area=True, measure_timing=False, compute_timing_metrics=False)
