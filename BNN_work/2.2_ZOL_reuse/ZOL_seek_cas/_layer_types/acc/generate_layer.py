...
def generate_layer_fpea(path, layer_name, input_neurons, output_neurons):
	...
	fpea += "COM input_ZOL : ZOL_cascade(\>\n"
...
def generate_layer_parameters_and_generics(path, layer_name, input_neurons, output_neurons, use_BRAMs):
	...
	input_ZOL_overwrites_width = 5 * math.ceil(tc_utils.unsigned.width(input_ZOL_overwrites) / 5)
	...
	generics = {
		...
		"input_ZOL_overwrites": "%s"%(tc_utils.unsigned.encode(input_ZOL_overwrites, input_ZOL_overwrites_width), ),
	}
